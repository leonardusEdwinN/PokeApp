...
class ListPokemonVC : UIViewController{
    ...
    @IBAction func myPokemonListButtonPressed(_ sender: Any) {
        performSegue(withIdentifier: "GoToMyPokemonList", sender: self)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        } else if segue.identifier == "GoToMyPokemonList" {
            if let destVC = segue.destination as? DetailPokemonVC {
                destVC.modalPresentationStyle = .fullScreen
            }
        }
